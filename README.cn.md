...
[![x-cmd/install — lla Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/lla.svg?lang=zh)](https://x-cmd.com/install/lla)
...
合计: **57,618** 行代码（覆盖前 5 种语言、共 **248** 个文件）。
...
- **上游仓库**: <https://github.com/chaqchase/lla>
- **许可证**: MIT

## 发布

- **最新版本**: `v0.6.5` (2026-09-21)
- **最近提交**: 2026-09-21
- **Release 含资产**: 36 个

## 流行度

- **Star**: 1,224 · **Fork**: 25 · **开放 issue**: 57 · **贡献者**: 11

## 累计统计

- **发布数**: 49 · **已合并 PR**: 111 · **开放 PR**: 0 · **已关闭 issue**: 55 · **开放 issue**: 2 · **提交数**: 621

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-24 | 1 | 2 | 0 | 0 | 0 | 2 |
| last60d | 2026-07-25 | 9 | 13 | 0 | 3 | 1 | 46 |
| 90d | 2026-06-25 | 11 | 16 | 0 | 4 | 1 | 54 |
| last180d | 2026-03-27 | 14 | 22 | 0 | 5 | 1 | 76 |
| 360d | 2025-09-28 | 19 | 35 | 0 | 12 | 1 | 127 |
| last720d | 2024-10-03 | 38 | 106 | 0 | 54 | 2 | 562 |
...
lla 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `lla` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/lla.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T04:53:20Z._
